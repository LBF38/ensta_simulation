...
public class CreateWorkshops extends SimEvent {
    ...
    public void process() {
        ...
        initWorkshops.add(new InitWorkshop("Terres chaudes", InitWorkshop.Frequenting.PLANNED, open_7_15, close_14, 6, 20, 20, 60, 10, 3, InitWorkshop.QueueType.ORGANIZED, 10));
        initWorkshops.add(new InitWorkshop("jets filiformes", InitWorkshop.Frequenting.FREE, open_10, close_13, 4, 5, 30, 28, 4, 2, InitWorkshop.QueueType.RANDOM, 10));
        initWorkshops.add(new InitWorkshop("étuves", InitWorkshop.Frequenting.PLANNED, open_7_15, close_14, 6, 15, 15, 21, 5, 3, InitWorkshop.QueueType.ORGANIZED, 6));
        initWorkshops.add(new InitWorkshop("bains à jets", InitWorkshop.Frequenting.FREE, open_7_15, close_14, 9, 20, 10, 35, 4, 2, InitWorkshop.QueueType.ORGANIZED, 15));
        initWorkshops.add(new InitWorkshop("douches", InitWorkshop.Frequenting.FREE, open_7_15, close_14, 8, 10, 10, 49, 2, 2, InitWorkshop.QueueType.RANDOM, 8));
        initWorkshops.add(new InitWorkshop("soins du visage", InitWorkshop.Frequenting.FREE, open_7_15, close_14, 8, 10, 5, 365, 40, 1, InitWorkshop.QueueType.RANDOM, 5));
