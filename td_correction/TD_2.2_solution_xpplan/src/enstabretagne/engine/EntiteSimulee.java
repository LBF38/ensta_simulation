...
public abstract class EntiteSimulee {
     ...
     * attention: quand une entit� parente cr�e une entit� fille c'est � elle
     * qu'incombe
     * de demander son initialisation via le requestInit().
     * en effet, le moteur ne peut pas savoir quand il est opportun de d�clencher
     * l'init pour cette entit�
     */

    public void requestInit() {
        if (etat == EtatEntite.NONE)
            init();
    }
